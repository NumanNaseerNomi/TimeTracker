...
switch($filterRecord)
{
    ...
    {
        $toDate = date("Y-m-d");
        $sql = "SELECT SQL_NO_CACHE * FROM records WHERE checkin LIKE '$toDate%' && checkout IS NOT NULL ORDER BY id DESC";
        break;
    }
    case 'yesterday':
    {
    ...
    case 'thisWeek':
    {
        ...
        $toDate = date("Y-m-d");
        $sql = "SELECT SQL_NO_CACHE * FROM records WHERE checkin BETWEEN '$fromDate' AND '$toDate' AND checkout IS NOT NULL ORDER BY id DESC";
        break;
    }
    case 'lastWeek':
    {
    ...
    case 'all':
    {
        $sql = "SELECT SQL_NO_CACHE * FROM records WHERE checkout IS NOT NULL ORDER BY id DESC";
        break;
    }
}
